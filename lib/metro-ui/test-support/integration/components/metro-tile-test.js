...
test('no size declaration creates square', function (assert) {
	...
	assert.ok(this.$('> *').hasClass('tile-square'), 'should be standard square tile');
});
...
test('can declare small tile', function (assert) {
	...
	assert.ok(this.$('> *').hasClass('tile-small'), 'should be a small tile');
});
...
test('can declare wide tile', function (assert) {
	...
	assert.ok(this.$('> *').hasClass('tile-wide'), 'should be a wide tile');
});
...
test('can declare large tile', function (assert) {
	...
	assert.ok(this.$('> *').hasClass('tile-large'), 'should be a large tile');
});
...
test('is transparent by default', function (assert) {
	...
	assert.ok(this.$('> *').hasClass('ol-transparent'), 'should be transparent');
});
